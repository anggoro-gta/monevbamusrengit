...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>TTD <?= $nama_kecamatan; ?> (<?= $nama_bidang; ?>)</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="/inputttd/<?= $idkec; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>
                            <a href="/inputttddarimaster/<?= $idkec; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Ambil database</button></a>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $hitungdatattd = count($data_ttd); ?>
                                    <?php for ($i = 0; $i < $hitungdatattd; $i++) : ?>
                                        <tr>
                                            <td><?= $i + 1; ?></td>
                                            <td><?= $data_ttd[$i]['jenis']; ?></td>
                                            <td><?= $data_ttd[$i]['nama_penandatangan']; ?></td>
                                            <td><?= $data_ttd[$i]['instansi']; ?></td>
                                            <td><?= $data_ttd[$i]['nip']; ?></td>
                                            <td><img src="<?= base_url() . $data_ttd[$i]['link_image']; ?>" height="90" width="120" alt=""></td>
                                            <td>
                                                <button onclick="showdelete('<?= $data_ttd[$i]['id']; ?>')" type="button" class="btn btn-block btn-danger"><i class="fas fa-minus-circle"></i> Delete</button>
                                            </td>
                                        </tr>
                                    <?php endfor; ?>
                                </tbody>
