...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>INPUT MASTER TTD - (<?= $nama_bidang; ?>)</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <form action="/savemasterttd" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                ...
                <div class="card-footer">
                    <a href="/masterttd"><button type="button" class="btn btn-secondary"><i class="fas fa-arrow-circle-left"></i> Kembali</button></a>
                </div>
                <!-- /.card-body -->
            </div>
            <!-- /.card -->
