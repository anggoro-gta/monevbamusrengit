...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>AMBIL TTD (<?= $nama_bidang; ?>)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Data</a></li>
                        <li class="breadcrumb-item active">Ambil TTD</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                                ...
                                <tbody>
                                    ...
                                    <?php for ($i = 0; $i < $hitungmasterttd; $i++) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/saveambildarimasterttd/<?= $idkec; ?>/<?= $master_ttd[$i]['id']; ?>"><button type="button" class="btn btn-block btn-success"> Ambil ttd</button></a>
                                            </td>
                                        </tr>
                                    <?php endfor; ?>
                                </tbody>
