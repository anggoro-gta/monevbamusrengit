...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>NOMOR TTD <?= $nama_kecamatan; ?> (<?= $nama_bidang; ?>)</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Data</a></li>
                        <li class="breadcrumb-item active">nomor ttd</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <?php if ($count_nomorttd == 0) { ?>
                            <div class="card-header">
                                <a href="/inpunomorttd/<?= $idkec; ?>"><button type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Tambah Data</button></a>
                            </div>
                        <?php } else if (($count_nomorttd == 1)) { ?>
                        <?php } ?>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $hitungdatanomorttd = count($data_nomorttd); ?>
                                    <?php for ($i = 0; $i < $hitungdatanomorttd; $i++) : ?>
                                        <tr>
                                            <td><?= $i + 1; ?></td>
                                            <td><?= $data_nomorttd[$i]['nomor']; ?></td>
                                            <td>
                                                <button onclick="showdelete('<?= $data_nomorttd[$i]['id']; ?>')" type="button" class="btn btn-block btn-danger"><i class="fas fa-minus-circle"></i> Delete</button>
                                            </td>
                                        </tr>
                                    <?php endfor; ?>
                                </tbody>
